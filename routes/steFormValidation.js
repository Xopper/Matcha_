...
const primaryValidation = (values) =>{
    ...
    if (values.gender === '' || typeof values.gender === undefined)
    ...
    if (values.bio === '' || typeof values.bio === undefined)
    ...
    if (values.birthday === '' || typeof values.birthday === undefined)
    ...
    if (values.profilePic1 === '' || values.profilePic1 === undefined)
        errors.profilePic1 = "Profile image is required"
    ...
    if (values.tags.length === 0 || values.tags.length > 5)
        ...
        if (errlentag.length !== 0)
            errors.tags = "Tags length must be between 1 and 20 characters"
    }
    return errors;
}
...
const stepFormValidator = (req, res, next) =>{
    ...
    if ((values.latitude < -90.0000000 || values.latitude > 90.0000000) && (values.longitude < -180.0000000 || values.longitude > 180.0000000))
