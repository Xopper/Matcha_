				...
				<div className='browse__content'>
					...
					<div className='sort__specs'>
						<div className='sort__box'>
							<input type='radio' id='age' name='sortHandler' value='age' />
							<label htmlFor='age' className='clickable'>
								<strong>Age.</strong>
							</label>
						</div>
						<div className='sort__box'>
							<input type='radio' id='location' name='sortHandler' value='location' />
							<label htmlFor='location' className='clickable'>
								<strong>Location.</strong>
							</label>
						</div>
						<div className='sort__box'>
							<input type='radio' id='fameRating' name='sortHandler' value='fameRating' />
							<label htmlFor='fameRating' className='clickable'>
								<strong>Fame Rating.</strong>
							</label>
						</div>
						<div className='sort__box'>
							<input type='radio' id='communTags' name='sortHandler' value='communTags' />
